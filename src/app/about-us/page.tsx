        ...
        <div className="flex  container lg:py-10 items-center flex-col lg:flex-row">
          ...
          <div className="basis-1/2">
            ...
            <p className="mt-3 mb-5">
              ...
              offer high-quality products at competitive prices. Our
              user-friendly website ensures a seamless purchasing experience
              with secure payment options, fast delivery, and excellent customer
              support. Stay ahead of the tech curve with Broxgadgets – where
            ...
            {QUALITIES.map((item) => (
              <div key={item.first_text} className="">
                ...
                <h4 className="font-bold  text-sm lg:text-lg text-center">
                  {item.first_text} <br />
                  <span className="text-primary">{item.second_text}</span>{" "}
                  <br />
                  {item.third_text}
                </h4>
              </div>
